...
ActiveRecord::Schema.define(version: 20170530144747) do
  ...
  create_table "features_listings", id: false, force: :cascade do |t|
    ...
    t.index ["listing_id", "feature_id"], name: "index_features_listings_on_listing_id_and_feature_id"
  end
